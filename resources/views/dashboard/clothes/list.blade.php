        ...
        <div class="row">
            ...
            <div class="box box-primary box-solid">
                    ...
                    <div class="box-body table-responsive">
                        <table id="clothes_table" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>رقم التسلسل</th>
...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            if ($('#clothes_table').length > 0) {
            var tableData = $('#clothes_table').DataTable({
                    //stateSave: true,
                    ...
                    columns: [
                        {data: 'CLOTHES_ID', name: 'CLOTHES_ID', 'visible': false},
