        ...
        <div class="row">
            ...
            <div class="box box-primary box-solid">
                    <div class="box-header box-header-background with-border">
                        <h3 class="box-title">درجه الطبيب</h3>
                        <div class="box-tools pull-right">
                            <a href="{{ url('dashboard/docDegrees/create ')}}" class="btn btn-warning" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp; أضافه جديد</a>
                        </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            var tableData = $('#docDegrees_table').DataTable({
                    ...
                    columns: [
                        {data: 'DEGREES_ID', name: 'DEGREES_ID', 'visible': false},
