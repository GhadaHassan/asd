        ...
        <div class="row">
            ...
            <div class="box box-primary box-solid">
                    <div class="box-header box-header-background with-border">
                        <h3 class="box-title">المرحله الدراسيه</h3>
                        <div class="box-tools pull-right">
                            <a href="{{ url('dashboard/levels/create ')}}" class="btn btn-warning" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp; أضافه جديد</a>
                        </div>
                    </div>
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            var tableData = $('#docDegrees_table').DataTable({
                    ...
                    columns: [
                        {data: 'LEVEL_ID', name: 'LEVEL_ID', 'visible': false},
                        {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
                        {data: 'LEVEL_TEXT', name: 'LEVEL_TEXT'},
