        ...
        <div class="row">
            ...
            <div class="box box-primary box-solid">
                    <div class="box-header box-header-background with-border">
                        <h3 class="box-title">الصفوف الدراسيه</h3>
                        <div class="box-tools pull-right">
                            <a href="{{ url('dashboard/groups/create ')}}" class="btn btn-warning" style="padding-bottom: 3px;"> <i class="fa fa-plus" aria-hidden="true"></i>&nbsp; اضافه جديد</a>
                        </div>
                    </div>

                    <div class="box-body table-responsive">
                        <table id="groups_table" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>رقم التسلسل</th>
...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            var tableData = $('#groups_table').DataTable({
                    //stateSave: true,
                    ...
                    columns: [
                        ...
                        {data: 'GROUP_TEXT', name: 'GROUP_TEXT'},
                        // {data: 'category_name', name: 'category_name'}
                        {data: 'levels', name: 'levels.LEVEL_TEXT'},
