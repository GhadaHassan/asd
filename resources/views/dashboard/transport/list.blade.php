        ...
        <div class="row">
            ...
            <div class="box box-primary box-solid">
                    ...
                    <div class="box-body table-responsive">
                        <table id="transport_table" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>رقم التسلسل</th>
...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            var tableData = $('#transport_table').DataTable({
                    //stateSave: true,
                    ...
                    columns: [
                        {data: 'TRANSPORT_ID', name: 'TRANSPORT_ID', 'visible': false},
