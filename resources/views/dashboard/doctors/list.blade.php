        ...
        <div class="row">
            ...
            <div class="box box-primary box-solid">
                    ...
                    <div class="box-body table-responsive">
                        <table id="doctors_table" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>رقم التسلسل</th>
...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            if ($('#doctors_table').length > 0) {
            var tableData = $('#doctors_table').DataTable({
                    //stateSave: true,
                    ...
                    columns: [
                        {data: 'DOCTOR_ID', name: 'DOCTOR_ID', 'visible': false},
                        {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
                        {data: 'EXPERIENCE_YEARS', name: 'EXPERIENCE_YEARS'},
                        {data: 'specialt', name: 'specialt.TEXT'},
                        {data: 'degree', name: 'degree.TEXT'},
