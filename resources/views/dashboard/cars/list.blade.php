        ...
        <div class="row">
            ...
            <div class="box box-primary box-solid">
                    ...
                    <div class="box-body table-responsive">
                        <table id="cars_table" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>رقم التسلسل</th>
...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            var tableData = $('#cars_table').DataTable({
                    //stateSave: true,
                    ...
                    columns: [
                        {data: 'CAR_ID', name: 'CAR_ID', 'visible': false},
                        {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
                        {data: 'NAME', name: 'NAME'},
                        {data: 'SERVICE_PHONE', name: 'SERVICE_PHONE'},
