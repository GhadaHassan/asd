...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            if ($('#restaurants_table').length > 0) {
            var tableData = $('#restaurants_table').DataTable({
                    //stateSave: true,
                    ...
                    columns: [
                        {data: 'REST_ID', name: 'REST_ID', 'visible': false},
                        {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
                        {data: 'REST_NAME', name: 'REST_NAME'},
                        {data: 'REST_DETAILS', name: 'REST_DETAILS'},
