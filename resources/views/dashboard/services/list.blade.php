...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            var tableData = $('#services_table').DataTable({
                    //stateSave: true,
                    ...
                    columns: [
                        {data: 'SERVICE_ID', name: 'SERVICE_ID', 'visible': false},
                        {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
                        {data: 'SERVICE_TEXT', name: 'SERVICE_TEXT'},
                        // {data: 'category_name', name: 'category_name'}
                        {data: 'department', name: 'departments.DEPARTMENT_TEXT'},
