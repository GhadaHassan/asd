        ...
        <div class="row">
            ...
            <div class="box box-primary box-solid">
                    <div class="box-header box-header-background with-border">
                        <h3 class="box-title">السوبر ماركيت</h3>
                    ...
                    <div class="box-body table-responsive">
                        <table id="markets_table" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>رقم التسلسل</th>
...
@section('js')
    ...
    $(document).ready(function () {
        ...
        //$(window).bind("load", function() {
            ...
            if ($('#markets_table').length > 0) {
            var tableData = $('#markets_table').DataTable({
                    //stateSave: true,
